...
const events = [
  {
    ...
    url: 'http://reddingstartupweekend.co',
    date: 'Oct 21-23',
  },
  {
  ...
  {
    name: 'Course: React+Redux',
    url: 'https://www.codementor.io/classes/learn-reactjs-and-redux-live',
    date: 'Oct 26',
  },
];
...
const styles = {
  ...
  events: {
    ...
    backgroundImage: 'url(/static/starting-a-startup.jpg)',
      ...
      <div style={[ styles.item, styles.events ]}>
        ...
        <div style={styles.eventList}>
          { events.map( ( event, idx ) =>
            <Link
              key={event.url}
              style={[ styles.event, events.length - 1 === idx && styles.eventLast ]}
              to={event.url}
              target="_blank"
            >
